...
```{r}
m1 <- mahalanobis(x = diseasedata[,1:2],
          center = c(mean(diseasedata[,1]), mean(diseasedata[,2])),
          cov = cov(diseasedata[,1:2]))
m1
m1>36.84136

m2 <- mahalanobis(x = diseasedata[,2:3],
          center = c(mean(diseasedata[,2]), mean(diseasedata[,3])),
          cov = cov(diseasedata[,2:3]))

m2
m2>23.02585

m3 <- mahalanobis(x = diseasedata[,3:4],
          center = c(mean(diseasedata[,3]), mean(diseasedata[,4])),
          cov = cov(diseasedata[,3:4]))
m3
m3>23.02585

m4 <- mahalanobis(x = diseasedata[,4:5],
          center = c(mean(diseasedata[,4]), mean(diseasedata[,5])),
          cov = cov(diseasedata[,4:5]))
m4
m4>23.02585


m5 <- mahalanobis(x = diseasedata[,5:6],
          center = c(mean(diseasedata[,5]), mean(diseasedata[,6])),
          cov = cov(diseasedata[,5:6]))

m5
m5>23.02585


m6 <- mahalanobis(x = diseasedata[,6:7],
          center = c(mean(diseasedata[,6]), mean(diseasedata[,7])),
          cov = cov(diseasedata[,6:7]))

m6
m6>23.02585


m7 <- mahalanobis(x = diseasedata[,7:8],
          center = c(mean(diseasedata[,7]), mean(diseasedata[,8])),
          cov = cov(diseasedata[,7:8]))
...
m8 <- mahalanobis(x = diseasedata[,8:9],
          center = c(mean(diseasedata[,8]), mean(diseasedata[,9])),
          cov = cov(diseasedata[,8:9]))

m8
m8>23.02585


m9 <- mahalanobis(x = diseasedata[,9:10],
          center = c(mean(diseasedata[,9]), mean(diseasedata[,10])),
          cov = cov(diseasedata[,9:10]))
...
m10 <- mahalanobis(x = diseasedata[,10:11],
          center = c(mean(diseasedata[,10]), mean(diseasedata[,11])),
          cov = cov(diseasedata[,10:11]))
...
m11 <- mahalanobis(x = diseasedata[,11:12],
          center = c(mean(diseasedata[,11]), mean(diseasedata[,12])),
          cov = cov(diseasedata[,11:12]))
...
m12 <- mahalanobis(x = diseasedata[,12:13],
          center = c(mean(diseasedata[,12]), mean(diseasedata[,13])),
          cov = cov(diseasedata[,12:13]))
...
m13 <- mahalanobis(x = diseasedata[,13:14],
          center = c(mean(diseasedata[,13]), mean(diseasedata[,14])),
          cov = cov(diseasedata[,13:14]))
...
m14 <- mahalanobis(x = diseasedata[,14:15],
          center = c(mean(diseasedata[,14]), mean(diseasedata[,15])),
          cov = cov(diseasedata[,14:15]))
...
m15 <- mahalanobis(x = diseasedata[,15:16],
          center = c(mean(diseasedata[,15]), mean(diseasedata[,16])),
          cov = cov(diseasedata[,15:16]))
...
m16 <- mahalanobis(x = diseasedata[,16:17],
          center = c(mean(diseasedata[,16]), mean(diseasedata[,17])),
          cov = cov(diseasedata[,16:17]))
...
```{r}
m <- mahalanobis(x = diseasedata[,1:2],
          center = c(mean(diseasedata[,1]), mean(diseasedata[,2])),
          cov = cov(diseasedata[,1:2]))
m 
